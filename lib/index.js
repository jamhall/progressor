    ...
    _createClass(Progressor, [{
        ...
        value: function update(message) {
            ...
            if (this.formatLineCount) {
                this.output.write((0, _sprintf.sprintf)('\u001b[%dA', this.formatLineCount));
            }
        ...
        value: function initPlaceholders() {
            var placeholders = {
                'bar': function bar(_bar) {
                    ...
                    var display = _bar.getBarCharacter().repeat(completeBars);
                    if (completeBars < _bar.options.barWidth) {
                        ...
                        display = display + _bar.options.progressChar + _bar.options.emptyBarChar.repeat(emptyBars);
                    }
                    return display;
                },
