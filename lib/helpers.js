  ...
  _createClass(Helpers, null, [{
    ...
    value: function formatMemory(memory) {
      if (memory >= 1024 * 1024 * 1024) {
        return (0, _sprintf.sprintf)('%.1f GiB', memory / 1024 / 1024 / 1024);
      }
      if (memory >= 1024 * 1024) {
        return (0, _sprintf.sprintf)('%.1f MiB', memory / 1024 / 1024);
      }
      if (memory >= 1024) {
        return (0, _sprintf.sprintf)('%d KiB', memory / 1024);
      }
      return (0, _sprintf.sprintf)('%d B', memory);
    }
  }, {
